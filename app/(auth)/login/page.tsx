...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen hero-bg grid-pattern flex items-center justify-center p-4">
      <div className="fixed top-20 right-10 w-64 h-64 bg-indigo-600/20 rounded-full blur-3xl" />
      <div className="fixed bottom-20 left-10 w-80 h-80 bg-purple-600/20 rounded-full blur-3xl" />
